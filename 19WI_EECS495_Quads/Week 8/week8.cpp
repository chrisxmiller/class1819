...
void safety_check(Keyboard* keyboard){
  ...
  else if(abs(x_now) > 1000.0 || abs(y_now) > 1000.0){
    update_Time_vive();
    //check if 0.10s have passed
    if(timer_vive >= 0.10){
      trap(6);
